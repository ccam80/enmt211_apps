...
//      Horizontal load on a finite x-range track. Used by motion-transmission
//      lead-screw / ball-screw / conveyor and by PID-cart, three-carts, etc.
//      Returns: { W, H, padX, padY, trackY, usableW, mToPx,
//                 xToPx(xm), pxToX(px), xMin, xMax }
//      Options: { xMin = -0.6, xMax = +0.6, padX = 60, padY = 30,
//                 trackFrac = 0.55 }   // trackY = H * trackFrac
//
