...
(function () {
  ...
  function forceArrows(ctx, x, yTopBaseline, slots, opts) {
    ...
    // Old API skipped arrows whose drawn length was < 0.5 px. componentArrows
    // doesn't, so we filter here to preserve behaviour for tiny components.
    const items = [];
    ...
    // componentArrows lays slot i at (y − gap*i). Old API placed slot 0 at
