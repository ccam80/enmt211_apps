(function () {
  ...
  // ===========================================================================
  //  Production R1+R2+R3 render surface.
  //
  ...
  //  the production R1 material layer (element fill coloring factored into a
  //  standalone method). Magnets are pole-sign-coloured.
  //
  ...
  //  polyline (the mid-gap circle from BodyMesh.gapLoop) plus the
