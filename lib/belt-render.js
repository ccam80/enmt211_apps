...
(function () {
  ...
  function layout(L, p, opts) {
    ...
    // Lessons with the legacy "pulley centre at L.xMin/xMax" placement can
    // opt out via opts.inset = false, but new lessons should use the inset
    // layout and `loadXToPx` for both rendering and hit-tests.
