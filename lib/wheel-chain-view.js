...
//  rotational lesson built on LIB.WheelChain. Centralises the per-lesson
//  buildView/hitTestWheel/pointerAngleFor/wheelColor boilerplate.
//
//  Public surface:
//
...
(function () {
  ...
  function buildView(L, wheels, mode, opts) {
    ...
    // padPx defaults to 40 so wheel labels never clip on the rotational
